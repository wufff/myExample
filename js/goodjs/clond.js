...
(function ($) {
    ...
    */
    ...
    cloud.form.submit2 = function (options) {
        var defaults = {
            url: "",
            params: [],
            loading: "正在提交数据...",
     ...
     * @param  {Object} options  选项
     */
    cloud.form.install = function (options) {
        var defaults = {
            prompt: "注：您确定要安装此插件吗？",
            url: "",
            params: [],
    ...
    * @param  {Object} options  选项
    */
    cloud.form.uninstall = function (options) {
        var defaults = {
            prompt: "注：您确定要卸载此插件吗？",
            url: "",
            params: [],
    ...
    * @param  {Object} options  选项
    */
    cloud.form.default = function (options) {
        var defaults = {
            prompt: "注：您确定要设置此插件为默认吗？",
            url: "",
            params: [],
            loading: "正在设置插件...",
            success: null,
